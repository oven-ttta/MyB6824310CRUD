...
<body class="bg-light" style="background-image: url('{{ asset('Images/bg.svg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; background-attachment: fixed; min-height: 100vh;">
